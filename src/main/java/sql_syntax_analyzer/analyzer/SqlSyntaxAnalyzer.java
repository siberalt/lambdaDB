package sql_syntax_analyzer.analyzer;


import syntax_analyzer.analyzator.*;
import syntax_analyzer.compilator.CompilerInterface;
import syntax_analyzer.global_helpers.MapWrapper;
import syntax_analyzer.input_adapters.InputInterface;
import syntax_analyzer.lang_objects.LangObjectGenerator;
import syntax_analyzer.scanner.Scanner;
import syntax_analyzer.scanner.lexem.recognizer.*;
...
public class SqlSyntaxAnalyzer extends SyntaxAnalyzer {
    ...
    public static LexemeRecognizerInterface[] lexemeRecognizers = {
        ...
        new KeywordRecognizer(new MapWrapper<Enum<? extends Enum<?>>, String>()
            ...
            .add(Alphabet.T_ORDER_BY, "ORDER_BY")
    ...
    public void init() {
        LangObjectGenerator<Alphabet> generator = new LangObjectGenerator<>(Alphabet.class);
        ...
        this.setRuleManager(new RuleManager(this.scanner, SqlSyntaxAnalyzer.rules()).setLangObjectGenerator(generator));
        ...
        setLangObjectGenerator(generator);
